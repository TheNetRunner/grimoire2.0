...
@Component({
  selector: 'app-magician-step',
  templateUrl: './magician-step.component.html',
  styleUrl: './magician-step.component.css'
})
export class MagicianStepComponent {
    // private formGroupBuilder = inject(FormBuilder);
    // private characterService = inject(CharacterService);
    // private magicianService = inject(MagicianService);
    ...
    //     this.attributeForm = this.formGroupBuilder.group({
    //         buildPoints: [this.character.specialAttributes., attributeFormValidators],
    //         increases: [this.character.magic.attribute.increases, attributeFormValidators]
    //     });
