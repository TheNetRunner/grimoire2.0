import { MetaTypeName, MetaTypeDescriptions } from "../interfaces/meta-type.interface";
...
export const metaTypeDescriptions: MetaTypeDescriptions = {
	...
	[MetaTypeName.Dwarf]: {
		...
		text: "Dwarves as you may guess, are shorter and stockier than humans. They tend to be quite strong and very resilient, able to recover from damage ranging from knocks to the head to doses of hemlock. Or knocks to the head with a club wrapped in hemlock leaves. Dwarfs are hard workers and tend to be highly valued by corporations, which means they are more deeply integrated into human society than the other metatypes. They still face discrimination due to their size, and they often have to take steps to make a world built for humans suitable for them.",
	},
};
